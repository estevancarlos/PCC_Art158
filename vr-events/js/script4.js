...
document.querySelector('#camera-anim').addEventListener('animationend', function () {
    ...
    document.querySelector('#camera-anim3').emit('camera-start-3');
});

document.querySelector('#podium-2-toggle').addEventListener('mouseenter', function () {
    document.querySelector('#camera-anim4').emit('camera-start-4');
    document.querySelector('#camera-anim5').emit('camera-start-5');
});